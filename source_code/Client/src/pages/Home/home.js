                    ...
                    <Row justify="center" align="top" key="1" style={{ display: 'flex' }}>
                        ...
                        <Col span={15} style={{ height: '100%' }}>
                            <Carousel autoplay className="carousel-image" style={{ height: '100%' }}>
                                ...
                                <div className="img">
                                    <img style={{ width: '100%', height: 300, objectFit: 'cover' }} src="https://marketingtoancau.com/files/product/quang-cao-facebook-quan-tri-fanpage-cho-linh-vuc-benh-vien-benh-vien-da-khoa-quoc-te-hoan-my-thu-duc-gvo7cuse.jpg" alt="" />
                                </div>
                                <div className="img">
