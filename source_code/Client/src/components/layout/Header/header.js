...
function Topbar() {
  ...
  return (
    ...
    >
      <div className="">
        <img style={{ color: "#000000", fontSize: 15, height: 55, width: 300, cursor: "pointer" }} src="https://i.namu.wiki/i/a3GkhQuvwxycyyNIHB1NyYbwBoGS_F97T7a5UpDWQpnn7RpltuCq7rTg9ydpB2-Irum_UE05LSyhWR9tsGTEwA.svg" onClick={() => handleLink("/home")}></img>
      </div>
